...
const ShowSuccess = ({ response, setSignUpResponse }: any) => {
  ...
  return (
    <div className="flex  h-screen  justify-center items-center">
      <div className="text-lg gap-3 flex-col bg-white  flex h-96 w-[300px] sm:w-[500px] rounded-md items-center justify-center">
          ...
          <p className=" gap-1 font-semibold flex-col flex justify-center items-center ">
            {response?.accessToken !== undefined ? (
              <>
                ...
                <p className="mt-4 text-[14px] sm:text[17px]">
